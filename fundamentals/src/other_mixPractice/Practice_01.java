...
public class Practice_01 {
	...
	public void m7(int[] num, int number) {
		...
		System.out.println("Even count in an array :: " + even);
		System.out.println("Odd count in an array :: " + odd);
		...
		System.out.println("Even count in an array :: " + even_count);
		System.out.println("Odd count in an array :: " + odd_count);
	}
	...
	public void m14(int[] num, int lengths) {
		int[] a = new int[lengths];
		int j = 0;
		for (int i = 0; i < num.length; i++) {
			if (num[i] >= 0) {
	...
	public static void main(String[] args) {
		...
		obj.m12(factNumber);
		obj.m13(arr, arr2);
		obj.m14(arr, arr.length);
		System.out.println("Negative number on one side:: ");
		for (int i : arr) {
			System.out.println(i);
		}
		obj.m15(armNumber);
