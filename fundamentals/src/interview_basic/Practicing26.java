...
public class Practicing26 {

	void m1(int[] num, int lengths) {
		...
		System.out.println("Reverse array of an elements: ");
	...
	public static void main(String[] args) {
		int[] arr = { 11, 9, 2, 7, 5, 4, 2 };
		System.out.println("Array eleemnts");

		for (int i = 0; i < arr.length; i++) {
			System.out.println(arr[i]);
		}

		Practicing26 obj = new Practicing26();
